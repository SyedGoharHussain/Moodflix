  ...
  return (
    ...
    >
      ...
      <div className="hidden lg:flex flex-1 relative overflow-hidden" style={{ background: '#030308' }}>
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          ...
          <motion.div
            ...
            style={{
              ...
              background: 'radial-gradient(circle, rgba(229,9,20,0.045) 0%, transparent 65%)',
              filter: 'blur(50px)',
            }}
          />
        </div>
        ...
        <div className="relative z-10 flex flex-col justify-center px-14 py-12 max-w-lg">
          ...
          <motion.p
            ...
            className="text-ink-dim font-body text-sm leading-relaxed max-w-xs mb-10"
          >
            Our AI reads your emotional state and curates the perfect watchlist
          ...
          >
            {[0.3, 0.2, 0.1].map((opacity, i) => (
              <div
                ...
                style={{
                  background: `linear-gradient(90deg, rgba(0,212,255,${opacity}) 0%, rgba(124,92,255,${opacity * 0.7}) 100%)`,
                  width: `${55 - i * 12}%`,
                }}
              />
            ))}
      ...
      >
        ...
        >
          <div className="mb-8">
            <h1 className="font-display text-3xl text-ink font-extrabold tracking-tight mb-2">Welcome back</h1>
          ...
          <p className="text-center text-ink-dim text-sm mt-7 font-body">
            ...
            <Link to="/register" className="font-semibold transition-colors" style={{ color: '#00d4ff' }}>
              Create one
            </Link>
          </p>
        </motion.div>
